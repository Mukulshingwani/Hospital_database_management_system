...
if (isset($_POST['change'])) {
    ...
    $query = mysqli_query(
        $con,
        "update users set password='$newpassword' where fullName='$name' and email='$email'"
    );
    if ($query) {
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> Goyal Hospital | Patient Reset Password</h2></a>
				</div>
...
<i class="fa fa-lock"></i> </span>
					...
					<div class="copyright">
						&copy; <span class="text-bold text-uppercase">  Goyal Hospital</span>
					</div>
