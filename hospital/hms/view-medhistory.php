...
if (isset($_POST['submit'])) {
    ...
    $query .= mysqli_query(
        $con,
        "insert   tblmedicalhistory(PatientID,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres)value('$vid','$bp','$bs','$weight','$temp','$pres')"
    );
    if ($query) {
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle" style="color:white;">Users | Medical History</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Users</span>
...
<div class="container-fluid container-fullw bg-white" style="background-color:#001f3f; !important">
<div class="row">
<div class="col-md-12">
